...
tare_name = '2020-04-13_11-04-35.csv'
tare_path = os.path.join(tare_dir, date, tare_folder, tare_name)
tare_file = read_csv(tare_path)

raw_dir = r'C:/Users/mtirb/Documents/MSci-Project/Data/Raw Recorded Data'
raw_folder = tare_folder
raw_name = '6Steps_NotLIfted_5_(2020-04-13)_11-09-32.csv'
raw_path = os.path.join(raw_dir, date, raw_folder, raw_name)
raw_file = read_csv(raw_path)

# 2) Filter Values
filtered_values =filtered_values(raw_file)

# 3) Calibrate Values
calibrated_forces = post_calibrate_values(filtered_values, tare_file)
