...
#     print(combined_data[3])
    ...
    if carryout_CoP == True:
        ...
        if save_CoP == True:
            ...
            save_CoP_data( x, y, total_force, mid_times, start_time_date )
...
# penguin_data_recording(LCs, LCnums, carryout_CoP=False, save_CoP=False, plot_CoP = False, plot_tare = True, med_filt=False)
