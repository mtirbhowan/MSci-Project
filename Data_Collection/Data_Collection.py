...
#     print(combined_data[3])
    ...
    if carryout_CoP == True:
        ...
        x, x_e, y, y_e, total_force, total_force_e, mid_times = DA.calculate_CoP(calibrated_values, calibrated_errors, mid_times, plot_position_values=plot_CoP)
        ...
        if save_CoP == True:
            ...
            LS.save_CoP_data( x, x_e, y, y_e, total_force, total_force_e, mid_times, today, start_time_date , custom_title_per_walk = custom_title_per_walk, custom_title_for_session = custom_title_for_session)
...
def continuous_measurement(med_filt = False, use_trigger =True, carryout_CoP=False, save_CoP= False, plot_CoP = False, custom_title_per_walk = False, custom_title_for_session=False, save_raw = True):
    ...
    if custom_title_for_session == False:
        ...
        if not os.path.exists('/home/pi/Documents/MSci-Project/Data/Calibrated Data/{}'.format(today)):
            os.makedirs('/home/pi/Documents/MSci-Project/Data/Calibrated Data/{}'.format(today))
        ...
        if not os.path.exists('/home/pi/Documents/MSci-Project/Data/Calibrated Data/{}/{}'.format(today,custom_title_for_session)):
            os.makedirs('/home/pi/Documents/MSci-Project/Data/Calibrated Data/{}/{}'.format(today,custom_title_for_session))
    ...
    while run_number >= 0:
        ...
        tare_data, timeout_condition = penguin_data_recording(LCs,LC_nums,today,custom_title_per_walk=custom_title_per_walk,custom_title_for_session=custom_title_for_session,use_trigger=use_trigger,tare=take_tare,save_raw=save_raw,med_filt=med_filt,carryout_CoP=carryout_CoP,plot_CoP=plot_CoP,save_CoP=save_CoP)
        tare_taken = True
