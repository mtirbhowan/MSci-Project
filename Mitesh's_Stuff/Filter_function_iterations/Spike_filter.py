...
def spike_filter(df,col,num_of_filters=1,threshold_param = 5E5,filter_param1=-6E3,filter_param2=-1E3):
    """ Params:
...
y1 = spike_filter(df,col,num_of_filters=2)
